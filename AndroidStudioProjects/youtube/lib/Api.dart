...
const CHAVE_YOUTUBE = "AIzaSyBRZ82qDoabUQ5Lr1g6EwSlQ3sD_DuzvPk";
const CANAL = "UCemKUCHgBD12_p0RkfO-2pw";
const Type = "video";
const max = 20;
const URLBASE = "GET https://www.googleapis.com/youtube/v3/";


/*
class Api {

  YoutubeAPI ytApi = YoutubeAPI(CHAVE_YOUTUBE);
  ...
  pesquisar(String pesquisa) async{
    ...
    http.Response response = await http.get(
      URLBASE + "search"
          ...
          "&maxResults=20"
          "&order=date"
          "&key=AIzaSyBRZ82qDoabUQ5Lr1g6EwSlQ3sD_DuzvPk"
          "&channelId=$CANAL"
          "&q=$pesquisa"
    );
    ...
    if(response.statusCode == 200){
      ...
      print("Deuu certo " + response.body);
